...
rootdir = 'C:\_ARQ\05.Neuro\03.PhD\OneDrive - Brock University\05.Thesis\02.ProjectPhD\03.1-CamCAN MTL\08.Analysis\Analysis11\CCAPROOF94\proof92-cross_perm\emory_valence\allscores';
path2data    = fullfile(rootdir,'data');
path2results = fullfile(rootdir,'resultsallscores');
...
[A1,B1,R1,U1,V1,STATS1] = canoncorr(cca9a_xm307,cca9_ycog307_assoc_val);
[A2,B2,R2,U2,V2,STATS2] = canoncorr(cca9b_xf307,cca9_ycog307_assoc_val);
[A3,B3,R3,U3,V3,STATS3] = canoncorr(cca9c_xmf307,cca9_ycog307_assoc_val);
...
histogram(X,'FaceColor','g') creates a histogram plot with green bars.


figure;histogram([Mboot.fval1], 'FaceColor','0.8500 0.3250 0.0980');
hold on;histogram([Mboot.fval2], 'FaceColor','0.4940 0.1840 0.5560');
histogram([Mboot.fval3], 'FaceColor','0 0.4470 0.7410');
legend('M1','M2','M3');
